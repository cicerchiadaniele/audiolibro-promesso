...
window.CONFIG = {
  ...
  /* Percorso della cartella dentro Dropbox, mostrato in fondo alla pagina. */
  percorso: "/STUDIO CAI/01. Daniele/PROMESSI SPOSI",

  /* Chi coordina le letture: compare nel piè di pagina. */
  referente: {
    nome: "Daniele Cicerchia",
    email: ""            // lascia vuoto per non mostrare il recapito
  },
